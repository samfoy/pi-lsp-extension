...
/**
 * jdtls's own default `java.import.exclusions`, then generated dirs. No `build/` or `bin/`:
 * jdtls matches these globs against absolute paths, so they would also hide every project
 * of a workspace that lives under such a directory.
 */
export const JAVA_IMPORT_EXCLUSIONS: readonly string[] = [
  ...
  "**/archetype-resources/**",
  "**/META-INF/maven/**",
  "**/.bemol/**", // IDE project files generated by workspace tooling
  "**/.gradle/**",
];
...
export class LspManager {
  ...
  private getJavaInitializationOptions(): Record<string, unknown> {
    ...
    // Keep generated dirs out of the Eclipse resource tree: dirs that are
